...
namespace SGPdotNET.Observation
{
    ...
    public class GroundStation
    {
        ...
        /// <exception cref="ArgumentException">Thrown if start is greater than or equal to end, deltaTime is non-positive, resolution is not in range 0-7, or minElevation is greater than 90Â°</exception>
            ...
            int resolution=3)
        {
            ...
            if (minElevation!=null && minElevation.Degrees > 90) { throw new ArgumentException("minElevation cannot be greater than 90Â°", "minElevation"); }
